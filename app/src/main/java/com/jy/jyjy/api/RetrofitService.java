...
import com.jy.jyjy.MyApplication;
...
public class RetrofitService {
    ...
    private static final String JY_HOST = "http://store.famdr.net/";

    private static INewsApi sNewsService;
    private static IWelfareApi sWelfareService;
    private static IJyApi sJyService;
    // 递增页码
    ...
    public static void init() {
        ...
        retrofit = new Retrofit.Builder()
                ...
                .baseUrl(JY_HOST)
                .build();
        sJyService = retrofit.create(IJyApi.class);
     ...
     * 获取cookie
     * */
    public static  Observable<CookieInfo> getCookie(){
        return sJyService.getCookieInfo();
